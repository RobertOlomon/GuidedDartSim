...
dt_basis = 0.3;   % seconds between basis vector plots
indexInterval = round(dt_basis / sim.Timestep);
basis_indices = 1:indexInterval:N;  % select every indexInterval-th sample
scaleVec = 0.4;  % increased length of basis vectors for visualization
...
for idx = basis_indices
    ...
    quiver3(pos_true(1), pos_true(2), pos_true(3), scaleVec*R_true(1,2), scaleVec*R_true(2,2), scaleVec*R_true(3,2), 'Color', 'b', 'LineWidth', 2);
